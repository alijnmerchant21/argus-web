...
/**
 * Injected into the page's *main* world (not the content-script isolated world).
 * Patched `window.fetch` there actually intercepts ChatGPT / Claude / Gemini network calls.
 */
export function buildMainWorldInjection(rules: Rule[], enabled: boolean): string {
